...
- git clone https://github.com/oguntayomicheal/hello-rails-react.git
...
Feel free to check the [issues page](https://github.com/oguntayomicheal/hello-rails-react/issues).
